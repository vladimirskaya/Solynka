...
tipButtons.forEach((button) => {
	...
	//The largerthe number, the slower animation
	...
	button.addEventListener('click', ()=> {
		...
		//Wait for start flipping the coin because of the button tilt animation
		serTimeout(()=> {
			//randomize the flipping speeds just for function
